        ...
        <div class="row">
            <div class="col-md-12 owl-carousel">
                <div class="team-card mb-30">
                    <div class="team-img"><img src="{{ asset('') }}front/img/team/3.jpg" alt="" class="w-100"></div>
                ...
                <div class="team-card mb-30">
                    <div class="team-img"><img src="{{ asset('') }}front/img/team/2.jpg" alt="" class="w-100"></div>
                    <div class="team-content">
                ...
                <div class="team-card mb-30">
                    <div class="team-img"><img src="{{ asset('') }}front/img/team/1.jpg" alt="" class="w-100"></div>
                    <div class="team-content">
